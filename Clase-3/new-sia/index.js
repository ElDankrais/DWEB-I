...
// const numeros = [1, 2, 3, 4, 5, 5,6,7];

// //Devuelvan la suma de numeros
...
// const score = numeros.reduce((acc, curr) => acc + curr);

// // reduce con objetos:

// const frutas = ["manzana", "manzana", "pera", "uva", "uva", "uva"];

// //Agrupa los elementos en un diccionario (objeto) y pon la cantidad por cada uno


// const dicc = frutas.reduce((acc, fruta) => {
//   // Conjunción: &&
//   // Disyunción: ||
//   // Nullish operator: ??
//   // if (!acc[fruta]) {
...
// const cosasSaludables = [...frutas];

// cosasSaludables.push('dormir');

// console.log(cosasSaludables, frutas);

// const otroObj = {...dicc, saludo: 'Hola'};
...
// const {manzana: apple, pera} = dicc;
// console.log(apple, pera);

// // param destructuring

// function llamar({manzana}) {
//   console.log(`Tines ${manzana} manzanas`);
// }
